        ...
        success: function (data) {
            ...
            for(var i=0; i < data.length; i++){
                if(editor != undefined){
                    ...
                    $("input[name='file_inp']").val(data[i]['originalname']);
                    $("input[name='file_real_name']").val(data[i]['originalname']);
                    $("input[name='file_name']").val(imgname);
                    $("input[name='file_path']").val(path);
                    $("#down_btn_a").attr("download", data[i]['originalname']);
                    $("#down_btn_a").attr("href", "/file/"+imgname);
                }
